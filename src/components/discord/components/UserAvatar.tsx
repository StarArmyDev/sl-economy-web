...
const StyledUserAvatar = styled.div<{ $size: string; $statusSize: string; $fadeHover?: boolean; $isBig?: boolean }>`
...
export const UserAvatar = ({
    ...
    return (
        <StyledUserAvatar className={className} $size={avatarSize} $statusSize={statusSize} $fadeHover={fadeHover} $isBig={isBig}>
            <div className="avatar" style={{ backgroundImage: `url(${avatarUrl || constants.defaultAvatar})` }}>
                {children}
            </div>

import { Category, OptionType, SubCommandData, SubGroupData, NumericOptionData, CommandOptionData, ChoicesData } from '@app/models';
    ...
    const CommandsArray: Category[] = [
        {
            ...
            commands: [
                    ...
                    options: [
                        {
                            ...
                            name: 'stats',
                            description:
                                'Información estadística del bot, como el tiempo encendido, servidores en los que está, versión. etc',
                        },
                        {
                            type: OptionType.Subcommand,
                            name: 'release',
                ...
                },
                {
                    ...
                    description:
                        'Un menú de ayuda para obtener información sobre los comandos disponibles por categoría, además de enlaces útiles.',
                    options: [
                        {
                            type: OptionType.String,
                            name: 'command',
                ...
                },
                {
                    ...
                    description:
                        'Se acabó el tiempo largo para crear una tienda, puedes usar este comando para crear items muy similar al comando Config.',
                    options: [
                        {
                            type: OptionType.Subcommand,
                            name: 'import',
                ...
                },
                {
                    ...
                    description:
                        'Muestra las listas de bots disponibles para votar o donde se encuentra el bot junto con una pequeña descripcción.',
                },
            ],
        },
        {
            ...
            commands: [
                ...
                },
                {
                    name: 'dice',
                    descriptionShort:
                        'Tira un dado y obtén el número. Puedes poner del 1 al 6 y ganar o perder dinero si adivinas o si no.',
                    description:
            ...
            commands: [
                {
                    ...
                    description:
                        'Viste algo en la tienda y decides comprarlo, puedes comprarlo por una cantidad especifica o solo uno si no lo especificas.',
                    options: [
                        {
                            type: OptionType.String,
                            name: 'item_name',
                ...
                },
                {
                    ...
                    description:
                        'Hecha un vistaso rápido a tus cosas, ya sean ganadas, recibidas en una transferencia de items o compradas.',
                    options: [
                        {
                            type: OptionType.User,
                            name: 'member',
...
const OptionsComponent = (
    ...
    copyClipboard: (e: React.MouseEvent<HTMLElement, MouseEvent>, text: string) => void,
) => {
    return (
        <>
